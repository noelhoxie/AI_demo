"""
Todo List Dash app — uses shared DB connection from db_connection (connection string extracted and used there).
"""
import json
import dash
...
# Initialize database (uses connection string from db_connection)
